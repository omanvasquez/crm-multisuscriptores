        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <a 
                ...
                className="text-[11px] text-slate-400 hover:text-emerald-400 transition-colors flex items-center gap-1 group"
              >
                <span>Por <span className="font-semibold text-slate-300 group-hover:text-emerald-300">Oman Vásquez</span></span>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <button
              ...
              className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-slate-800/80 hover:bg-slate-800 text-slate-200 border border-slate-700/80 hover:border-emerald-500/50 transition-all text-xs group"
            >
              <div className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse"></div>
              <div className="flex items-center gap-1 font-medium">
                <span className="text-slate-400 hidden xs:inline">BCV:</span>
                <span className="text-emerald-400 font-semibold">{formattedRate}</span>
                <span className="text-[10px] text-slate-400">Bs/$</span>
              </div>
              <TrendingUp className="w-3.5 h-3.5 text-slate-400 group-hover:text-emerald-400 transition-colors" />
            </button>
            ...
            <button
              ...
              className="p-2 rounded-xl bg-slate-800/80 hover:bg-slate-800 text-slate-300 hover:text-emerald-400 border border-slate-700/80 transition-all hidden sm:flex items-center"
            >

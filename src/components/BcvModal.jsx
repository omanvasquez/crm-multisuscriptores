  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm">
      <div className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl relative">
        ...
        {/* Current status */}
        <div className="mt-6 p-4 rounded-2xl bg-slate-950/70 border border-slate-800 space-y-2">
          <div className="flex items-center justify-between">
            <span className="text-xs text-slate-400">Tasa activa:</span>
        ...
        <form onSubmit={handleSave} className="mt-6">
          ...
          <div className="relative">
            <input
              ...
              className="w-full px-3.5 py-2.5 rounded-xl bg-slate-950/70 border border-slate-800 text-slate-100 font-bold text-sm focus:outline-none focus:border-emerald-500 transition-colors"
            />

...
export default function ClientCard({ 
  ...
  const isOverdue = diffDays < 0 || !client.estado_pago;
  ...
  return (
    <div className={`rounded-2xl border transition-all duration-200 relative group overflow-hidden ${
      ...
      {/* Top Accent Strip */}
      <div className={`h-1.5 w-full ${isOverdue ? 'bg-rose-500' : 'bg-emerald-500'}`} />

      <div className="p-5">
        
        {/* Header: Title, App Badge, and Menu */}
        ...
        <div className="mt-4 space-y-1.5 text-xs text-slate-400">
          ...
          <div className="flex items-center gap-2">
            ...
            <span>
              Corte: <strong className={isOverdue ? 'text-rose-400' : 'text-slate-200'}>
        ...
        <div className="mt-5 p-3 rounded-xl bg-slate-950/60 border border-slate-800/80 flex items-center justify-between">
          <div>
            <span className="text-[10px] text-slate-400 uppercase font-semibold">Tarifa Mensual</span>
        ...
        <div className="mt-4 grid grid-cols-2 gap-2">
          ...
          <button
            ...
            className="flex items-center justify-center gap-1.5 py-2.5 px-3 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white font-semibold text-xs shadow-md shadow-emerald-900/20 transition-all active:scale-95"
          >

...
export default function App() {
  ...
  if (authLoading) {
    return (
      <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col items-center justify-center text-slate-500 dark:text-slate-400 transition-colors duration-150">
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 flex flex-col selection:bg-emerald-500 selection:text-white transition-colors duration-150">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-24 sm:pb-12">
        ...
        <div className="bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800/80 rounded-2xl p-4 mb-6 shadow-sm backdrop-blur-sm transition-colors duration-150">
          <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-3">
            ...
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 rounded-xl bg-slate-100 dark:bg-slate-950/70 border border-slate-200 dark:border-slate-800 text-xs sm:text-sm text-slate-900 dark:text-slate-200 placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:border-emerald-500 transition-colors"
              />
            </div>
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <select
                ...
                className="py-2 px-3 rounded-xl bg-slate-100 dark:bg-slate-950/70 border border-slate-200 dark:border-slate-800 text-xs text-slate-700 dark:text-slate-200 focus:outline-none focus:border-emerald-500 transition-colors"
              >
              ...
              {/* Status Filter Pills */}
              <div className="inline-flex rounded-xl bg-slate-100 dark:bg-slate-950/70 p-1 border border-slate-200 dark:border-slate-800 text-xs flex-wrap gap-0.5">
                <button
        ...
        {loadingClients ? (
          ...
          <div className="bg-white dark:bg-slate-900/30 border border-slate-200 dark:border-slate-800/80 rounded-3xl p-12 text-center shadow-sm">
            <Building2 className="w-12 h-12 mx-auto text-slate-400 dark:text-slate-600 stroke-1 mb-3" />
            <h3 className="text-base font-bold text-slate-900 dark:text-white">No se encontraron comercios</h3>
      ...
      {clientToDelete && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/70 backdrop-blur-sm">
          <div className="w-full max-w-sm bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-2xl text-center">
            <div className="w-12 h-12 rounded-2xl bg-rose-500/10 text-rose-500 dark:text-rose-400 border border-rose-500/20 flex items-center justify-center mx-auto mb-4">
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 mt-2">
              Se desactivará <strong className="text-slate-800 dark:text-slate-200">{clientToDelete.nombre_negocio}</strong> de las vistas activas mediante Soft Delete. Su historial de pagos no se perderá.
            </p>
